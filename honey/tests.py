...
def test_honey_taste_view(client):
...
def test_add_honey_taste_view_post_success(client):
    url = reverse('honey_taste')
    data = {'taste': 'Akacja'}
...
@pytest.mark.django_db
def test_add_honey_taste_view_duplicate(client):
    url = reverse('honey_taste')
...
def test_honey_type_view(client):
...
@pytest.mark.django_db
def test_add_honey_type_view_post_success(client):
    url = reverse('honey_type')
    data = {'type': 'kremowany'}
    response = client.post(url, data)
    assert response.status_code == 200
...
@pytest.mark.django_db
def test_add_honey_type_view_duplicate(client):
    url = reverse('honey_type')
...
def test_honey_variant_view(client):
...
@pytest.mark.django_db
def test_add_honey_variant_view_post_success(client):
    url = reverse('honey_variant')
    data = {'variant': '50'}
    response = client.post(url, data)
    assert response.status_code == 200
...
@pytest.mark.django_db
def test_add_honey_variant_view_duplicate(client):
    url = reverse('honey_variant')
...
@pytest.mark.django_db
def test_honey_offer_view(client):
...
@pytest.mark.django_db
def test_honey_offer_view_post_success(client, taste, honey_type, variant):
    url = reverse('honey_offer')
    data = {
        'taste': taste[0].pk,
...
@pytest.mark.django_db
def test_add_honey_offer_view_duplicate(client, taste, honey_type, variant):
    url = reverse('honey_offer')
...
@pytest.mark.django_db
def test_honey_update_offer_view(client, offer):
...
@pytest.mark.django_db
def test_honey_update_offer_view_correct_offer(client, offer):
...
@pytest.mark.django_db
def test_honey_update_offer_view_post_success(client, offer):
    url = reverse('update_offer', kwargs={'pk': offer[0].pk})
    data = {
        'price': 200,
        'quantity': 200
...
@pytest.mark.django_db
def test_honey_update_offer_view_form_validation(client, offer):
    url = reverse('update_offer', kwargs={'pk': offer[0].pk})
    data = {
        'price': '',
        'quantity':''
...
@pytest.mark.django_db
def test_honey_delete_offer_view(client, offer):
    url = reverse('delete_offer', kwargs={'pk': offer[0].pk})
    response = client.get(url)
    assert response.status_code == 200

@pytest.mark.django_db
def test_honey_delete_offer_view_correct_offer(client, offer):
    selected_offer = offer[0]
...
@pytest.mark.django_db
def test_honey_delete_offer_view_post_success(client, offer):
    selected_offer = offer[0]
    url = reverse('delete_offer', kwargs={'pk': selected_offer.pk})
...
@pytest.mark.django_db
def test_honey_delete_offer_view_message_contains(client, offer):
    url = reverse('delete_offer', kwargs={'pk': offer[0].pk})
    response = client.get(url)
